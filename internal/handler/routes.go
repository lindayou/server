...
import (
	...
	authority "server/internal/handler/authority"
	dictionary "server/internal/handler/dictionary"
	menu "server/internal/handler/menu"
	operation "server/internal/handler/operation"
	test "server/internal/handler/test"
